...
{/* 
    ...
    <Text className="text-white font-dm-bold text-3xl">Log in</Text>
    <Text className="text-gray-400 font-dm-medium text-base mt-2">
      Enter your email to continue
    </Text>
    ...
    <TouchableOpacity 
      className={`rounded-full py-5 px-6 flex-row items-center justify-center ${
        isValid ? 'bg-secondary' : 'bg-gray-700'
      }`}
      activeOpacity={isValid ? 0.8 : 1}
      onPress={handleContinue}
